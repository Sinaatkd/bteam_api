...
urlpatterns = [
    ...
    path('news-categories/edit/<int:pk>/', login_required(UpdateNews.as_view()), name='edit_news_category'),
    path('news-categories/delete/<news_id>/', login_required(delete_news), name='delete_news_category'),
